...
import 'package:doubt_out/doubts/chatScreen.dart';
import 'package:doubt_out/doubts/postDoubtScreen.dart';
import 'package:doubt_out/doubts/teacherFeetPage.dart';
...
class HomePageTeacher extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return HomePageTeacherState();
  }
}

class HomePageTeacherState extends State<HomePageTeacher> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: _selectedIndex == 0
          ...
          : _selectedIndex == 1
              ? AssignmentList(
                  subjectName: widget.classOrSubject,
                )
              : ProfilePage(),
